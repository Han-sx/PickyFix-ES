...
_INLINE_ uint32_t
max32(IN const uint32_t v1, IN const uint32_t v2) {
    uint32_t l_mask = secure_l32_mask(v1, v2); // 0 if v1 < v2, (-1) otherwise

    return (v1 & l_mask) | (v2 & ~l_mask);
}

_INLINE_ uint32_t
min32(IN const uint32_t v1, IN const uint32_t v2) {
    uint32_t l_mask = secure_l32_mask(v1, v2); // 0 if v1 < v2, (-1) otherwise
